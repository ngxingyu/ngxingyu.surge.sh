    ...
    actions: [
      {
        type: "add",
        path:
          "../site/src/blog-posts/{{convertDateIsoToYMD blogPostCreatedAt}}-{{dashCase blogPostTitle}}/index.svx",
        templateFile: "../templates/blog-post/index.svx.hbs",
      },
      {
        type: "add",
        path:
          "../site/src/routes/blog/{{dashCase blogPostTitle}}/index.svelte",
        templateFile: "../templates/blog-post/page.svelte.hbs",
      },
      {
        type: "add",
        path:
          "../site/static/blog-posts/{{convertDateIsoToYMD blogPostCreatedAt}}-{{dashCase blogPostTitle}}/cover.jpg",
